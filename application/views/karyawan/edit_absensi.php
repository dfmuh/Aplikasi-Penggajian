<div class="ml-5">
    <h1>Form Absensi</h1>
    <a href="<?php echo site_url('karyawan/absensi'); ?>" class="btn btn-secondary">Kembali ke Daftar Absensi</a>
    <?php if ($this->session->flashdata('error')) { ?> <!-- Tampilkan pesan error jika ada -->
        <p style="color:red"><?php echo $this->session->flashdata('error'); ?></p>
    <?php } ?>
    <div class="mt-3">
        <form method="post" action="<?php echo site_url('karyawan/absensi/save_absensi/' . $weekday); ?>">
