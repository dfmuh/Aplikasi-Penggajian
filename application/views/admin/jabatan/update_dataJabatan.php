	...
	<div class="card-body">
		<?php foreach ($jabatan as $j) : ?>
			<form method="POST" action="<?php echo base_url('admin/data_jabatan/update_data_aksi') ?>">
				...
				<div class="form-group">
					<label>Tunjangan Penugasan</label>
					<input type="number" name="tj_penugasan" class="form-control" value="<?php echo $j->tj_penugasan ?>">
					<?php echo form_error('tj_penugasan', '<div class="text-small text-danger"> </div>') ?>
				</div>
