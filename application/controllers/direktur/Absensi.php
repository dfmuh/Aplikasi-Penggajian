...
class Absensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('direktur/absensi', $data); // Menggunakan view 'direktur/absensi' sebagai halaman tampilan absensi
    ...
    public function save_absensi($weekday)
    {
        ...
        if ($result && !empty($result->keterangan)) {
            ...
            redirect('direktur/absensi/add_data/' . $nip . '/' . $bulan . '/' . $tahun . '/' . $keterangan);
        } else {
    ...
    public function form_absensi($weekday)
    {
        ...
        $this->load->view('template_direktur/header', $data);
        $this->load->view('template_direktur/sidebar');
        $this->load->view('direktur/edit_absensi', $data); // Menggunakan view 'direktur/edit_absensi' sebagai halaman tampilan absensi
        $this->load->view('template_direktur/footer');
    }
